-- Guard public_create_booking_v5 so Salonboard live locations can only book
-- verified SN setmenu mappings with rsv_term. This migration only redefines
-- the RPC; it does not mutate data.
