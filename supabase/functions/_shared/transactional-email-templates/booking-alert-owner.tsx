...
const remindCard = { backgroundColor: '#fff7ed', border: '1px solid #fdba74', padding: '12px 16px', borderRadius: '2px', marginTop: '14px' }
const remindText = { fontSize: '13px', color: '#9a3412', margin: 0, lineHeight: 1.6 }
